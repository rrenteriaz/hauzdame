...
interface InviteCleanerFormProps {
  teamId: string;
}

export default function InviteCleanerForm({ teamId }: InviteCleanerFormProps) {
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={handleReset}
              className="flex-1 rounded-lg border border-neutral-300 bg-white px-4 py-2 text-base font-medium text-neutral-700 hover:bg-neutral-50 active:scale-[0.99] transition"
            >
              Generar otro link
            </button>
          </div>
