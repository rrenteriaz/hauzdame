...
import { updateTeamProperties } from "../actions";
...
interface TeamPropertiesModalProps {
  isOpen: boolean;
  onClose: () => void;
  teamId: string;
...
export default function TeamPropertiesModal({
  isOpen,
  onClose,
  teamId,
  properties,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await updateTeamProperties(formData);
      onSaved();
      onClose();
    } catch (err: any) {
